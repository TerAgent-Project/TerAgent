...
class VisionCoordinationBenchmark(BaseBenchmark):
    ...
    def run(self) -> list[BenchmarkResult]:
        # NOTE: teragent.coordination is deprecated and removed.
        # This benchmark is disabled until migrated to teragent.orchestration.
        logger.warning(
            "VisionCoordinationBenchmark is disabled: teragent.coordination "
            "has been removed. Migrate to teragent.orchestration and re-enable."
        )
        return []
