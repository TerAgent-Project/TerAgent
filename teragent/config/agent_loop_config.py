...
class AgentLoopConfig:
    ...
    def from_toml(cls, config_path: str | None = None) -> AgentLoopConfig:
        ...
        instance = cls(
            ...
            max_tool_repair_attempts=raw.get("max_tool_repair_attempts", _agentd_config.get("max_tool_repair_attempts", 3)),
            max_consecutive_tool_failures=raw.get("max_consecutive_tool_failures", _agentd_config.get("max_consecutive_tool_failures", 5)),
            max_model_call_retries=raw.get("max_model_call_retries", _agentd_config.get("max_model_call_retries", 2)),
