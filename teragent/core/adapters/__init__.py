...
TAPAdapterRegistry. After importing, adapters can be created via:
    ...
    adapter = TAPAdapterRegistry.create("glm_native", base_url=..., api_key=...)
...
Available adapters:
  ...
  - glm_native:        GLM native adapter with thinking/cache/async support
...
from teragent.core.adapters import glm_native as _glm  # noqa: F401
