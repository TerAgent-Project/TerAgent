...
from teragent.core.prompts.design import DESIGN_PROMPT_DEFAULT, DESIGN_PROMPT_GLM, DESIGN_PROMPT_ANTHROPIC, DESIGN_PROMPT_DEEPSEEK
from teragent.core.prompts.design import DESIGN_PROMPT_DEEPSEEK_V4, DESIGN_PROMPT_GLM_5, DESIGN_PROMPT_MINIMAX_M3
...
from teragent.core.prompts.review import REVIEW_PROMPT_DEFAULT, REVIEW_PROMPT_GLM, REVIEW_PROMPT_ANTHROPIC, REVIEW_PROMPT_DEEPSEEK
from teragent.core.prompts.review import REVIEW_PROMPT_DEEPSEEK_V4, REVIEW_PROMPT_GLM_5, REVIEW_PROMPT_MINIMAX_M3
from teragent.core.prompts.chat import AGENT_PROMPT_DEFAULT, AGENT_PROMPT_GLM, AGENT_PROMPT_ANTHROPIC, AGENT_PROMPT_DEEPSEEK
from teragent.core.prompts.chat import CHAT_PROMPT_DEFAULT, CHAT_PROMPT_GLM, CHAT_PROMPT_ANTHROPIC, CHAT_PROMPT_DEEPSEEK
from teragent.core.prompts.chat import AGENT_PROMPT_DEEPSEEK_V4, AGENT_PROMPT_GLM_5, AGENT_PROMPT_MINIMAX_M3
from teragent.core.prompts.chat import CHAT_PROMPT_DEEPSEEK_V4, CHAT_PROMPT_GLM_5, CHAT_PROMPT_MINIMAX_M3
from teragent.core.prompts.sub_agent import SUB_AGENT_PROMPT_DEFAULT, SUB_AGENT_PROMPT_GLM, SUB_AGENT_PROMPT_ANTHROPIC, SUB_AGENT_PROMPT_DEEPSEEK
from teragent.core.prompts.sub_agent import SUB_AGENT_PROMPT_DEEPSEEK_V4, SUB_AGENT_PROMPT_GLM_5, SUB_AGENT_PROMPT_MINIMAX_M3
from teragent.core.prompts.execute import EXECUTE_PROMPT_DEFAULT, EXECUTE_PROMPT_GLM, EXECUTE_PROMPT_ANTHROPIC, EXECUTE_PROMPT_DEEPSEEK
from teragent.core.prompts.execute import EXECUTE_PROMPT_DEEPSEEK_V4, EXECUTE_PROMPT_GLM_5, EXECUTE_PROMPT_MINIMAX_M3
from teragent.core.prompts.execute import CUDA_TRITON_PROMPT_GLM_5
